...
public class ChessGameTests {
    ...
    @Test
    @DisplayName("Normal Make chessCode.Move")
    ...
    @Test
    @DisplayName("Invalid Make chessCode.Move")
    ...
    @DisplayName("chessCode.Pawn Promotion")
    ...
    @Test
    @DisplayName("Pinned chessCode.King Causes Stalemate")
    ...
    @Nested
    @DisplayName("Valid chessCode.Move Tests")
    public class ValidMoveTests {
         ...
         */
            ...
            //Enemy chessCode.Rook causing -xray check (white rook can't move out of line)
        ...
        @Test
        @DisplayName("chessCode.King Cannot chessCode.Move Into Check")
