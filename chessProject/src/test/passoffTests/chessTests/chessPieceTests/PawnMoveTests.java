...
public class PawnMoveTests {
    ...
    @Test
    @DisplayName("White Single chessCode.Move")
    ...
    @Test
    @DisplayName("Black Single chessCode.Move")
    ...
    @Test
    @DisplayName("White Double chessCode.Move")
    ...
    @Test
    @DisplayName("Black Double chessCode.Move")
    ...
    @Test
    @DisplayName("White chessCode.Move Blocked")
    ...
    @Test
    @DisplayName("Black chessCode.Move Blocked")
    ...
    @Test
    @DisplayName("Double chessCode.Move Blocked")
